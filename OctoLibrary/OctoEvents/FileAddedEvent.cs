...
{
    public class FileAddedEvent : IOctoprintEvent
    {
        ...
        #region Event specfic members
        public OctoFile OctoFile { get; set; } 
        #endregion
        ...
        public FileAddedEvent(string name, JObject payload)
        {
            ...
            this.OctoFile = new OctoFile(payload,true);
            //FileReadyForSlicing += OnFileReadyForSlicing;
            //FileSliced += OnFileSliced;
