...
namespace GcodeToMesh.GcodeClasses
{
...
public class GCodeHandler
{
    ...
    public IEnumerator LoadObject(string refs_download, string path_to)
    {
    ...
    public IEnumerator LoadObjectFolder(string refs_download, string path_to)
    {
